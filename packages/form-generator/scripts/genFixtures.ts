...
import { SAMPLE_PRESETS } from '../src/schema/samples';
import { TABLE_SAMPLE_PRESETS } from '../src/schema/samples/tables';
import { WORKFLOW_SAMPLE_PRESETS } from '../src/schema/samples/workflows';
